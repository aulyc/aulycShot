...
final class FilenameRuleCard: NSView, NSTextFieldDelegate {
    private enum Preset: Int, CaseIterable {
        ...
        var imageTemplate: String {
            ...
            case .short: return "aulycShot-{date}-{time}"
            case .compact: return "c-{date}-{time}"
            case .unique: return "aulycShot-{date}-{time}-{rand:3}"
            case .counter: return "aulycShot-{date}-{daily:3}"
        ...
        var recordingTemplate: String {
            ...
            case .short: return "aulycShot-rec-{date}-{time}"
            case .compact: return "r-{date}-{time}"
            case .unique: return "aulycShot-rec-{date}-{time}-{rand:3}"
            case .counter: return "aulycShot-rec-{date}-{daily:3}"
