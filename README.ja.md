...
<p align="center">
  macOS のメニューバースクリーンショットツール。<code>⌘</code> をダブルタップして、撮影、注釈、スクロール結合、美化、ピン留めまで進められます。
</p>
...
- **メニューバー履歴**：最近のスクリーンショットと抽出した色をローカルに保持し、すぐ再コピーできます。
...
3. 浮動ツールバーで注釈、色抽出、スクロール撮影、美化、保存、ピン留め、確認を行います。
...
| スクロール撮影 / 美化 / ピン留め | 仕上げと共有のための補助ツール |
