...
- No pin button directly in the merge workbench; it stays available through Continue Editing.
...
Add a focused `aulycShot/ImageMerge/` module with these units:
...
- Existing screenshot, record, image edit, clipboard edit, pin, and History flows still behave normally.
